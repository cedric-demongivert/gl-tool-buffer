...
describe('VertexStructureBuffer', function () {
  ...
  describe('#constructor', function () {
    it('create a buffer for the given structure with a capacity for 16 vertices and the STATIC_DRAW usage by default', function () {
      ...
      const buffer = new GroupedVertexStructureBuffer(structure)
    ...
    it('allows to define the starting capacity and usage of the underlying buffer', function () {
      ...
      const buffer = new GroupedVertexStructureBuffer(structure, 32, BufferUsage.STREAM_DRAW)
  ...
  describe('#clone', function () {
    it('clone the given buffer instance', function () {
      ...
      const buffer = new GroupedVertexStructureBuffer(structure, 3)
      ...
      const clone = GroupedVertexStructureBuffer.clone(buffer)
  ...
  describe('#capacity', function () {
    it('return the current buffer capacity', function () {
      ...
      const buffer = new GroupedVertexStructureBuffer(structure, 18)
  ...
  describe('#size', function () {
    it('return the current buffer size', function () {
      ...
      const buffer = new GroupedVertexStructureBuffer(structure, 20)
    ...
    it('change the current buffer size', function () {
      ...
      const buffer = new GroupedVertexStructureBuffer(structure, 60)
    ...
    it('can expand the buffer capacity if necessary', function () {
      ...
      const buffer = new GroupedVertexStructureBuffer(structure, 2)
  ...
  for (
    ...
    describe(`#setters(${VertexFieldType.toString(structureType)})`, function () {
      it(`create a setter for ${VertexFieldType.toString(structureType)} fields on demand`, function () {
        ...
        const buffer = new GroupedVertexStructureBuffer(structure, 3).push(2)

        buffer.setColor(0, 1, 2, 3).setColor(1, 4, 5, 6).setValue(1, 8)
  ...
  describe('#delete', function () {
    it('delete some content of the buffer', function () {
      ...
      buffer.push(3)
            .setToughness(0, 1).setToughness(1, 3).setToughness(2, 2)
            .setColor(0, 1, 2).setColor(1, 3, 4).setColor(2, 2, 3)
            .setTransformation(0, 1, 2, 3, 4)
  ...
  describe('#concat', function () {
    ...
    it('throw when you trying to concat two buffers with different format', function () {
      const buffer = new GroupedVertexStructureBuffer(new VertexStructure([
        ['toughness', VertexFieldType.FLOAT],
        ['color', VertexFieldType.FLOAT_VEC2],
        ['transformation', VertexFieldType.FLOAT_MAT2]
      ]), 3)
      ...
      const toConcatenate = new GroupedVertexStructureBuffer(new VertexStructure([
  ...
  describe('#equals', function () {
    ...
    it('return false if both buffer does not have the same structure', function () {
      const left = new GroupedVertexStructureBuffer(new VertexStructure([
        ['toughness', VertexFieldType.FLOAT],
        ['color', VertexFieldType.FLOAT_VEC2],
        ['transformation', VertexFieldType.FLOAT_MAT2]
      ]), 3)

      const right = new GroupedVertexStructureBuffer(new VertexStructure([
        ['toughness', VertexFieldType.INT],
        ['color', VertexFieldType.FLOAT_VEC2],
        ['transformation', VertexFieldType.FLOAT_MAT2]
      ]), 3)
    ...
    it('return false if both buffer does not have the same size', function () {
      ...
      const left = new GroupedVertexStructureBuffer(structure, 3)

      const right = new GroupedVertexStructureBuffer(structure, 3)
    ...
    it('return trie if both buffer are equals', function () {
      const structure = new VertexStructure([
        ['toughness', VertexFieldType.FLOAT],
        ['color', VertexFieldType.FLOAT_VEC2],
        ['transformation', VertexFieldType.FLOAT_MAT2]
